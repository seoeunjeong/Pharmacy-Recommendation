...
/*formController를 단위테스트하기위에 MockMVC를 사용
* pharmactRecommendationService는 mocking*/
class FormControllerTest extends Specification {
    ...
    def setup(){
        //FormController MockMvc객체로 만드는데
        /* 객체를 만들지 않고 mockmvc를 사용해서 요청하면 Controller 검증이 가능했는데 Mock 객체를 만들었을떄 차이가뭘까?*/
